...
def update_config(config, args):
    ...
    if _check_args('EQ_tranNum'):
        config.MODEL.VSSM.EQ_tranNum = args.EQ_tranNum
    if _check_args('dataset'):
        config.DATA.DATASET = args.dataset
    if _check_args('test_transform_angle'):
        config.test_transform_angle = args.test_transform_angle
