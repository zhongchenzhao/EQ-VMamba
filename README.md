...
# EQ-VMamba-Small
python -m torch.distributed.launch --nnodes=1 --node_rank=0 --nproc_per_node=8 --master_addr="127.0.0.1" --master_port=29501 main.py --cfg ./configs/vssm/eqvmambav2v_small_224.yaml --batch-size 128 --dataset imagenet100 --data-path <path-to-imagenet100 --output ./exp ;
```
...
bash ./tools/dist_train.sh ./configs/vssm1/upernet_vssm_4xb4-160k_voc12_ImageNet100-512x512_tiny.py 8;
...
CUDA_VISIBLE_DEVICES=0,1,6,7 bash ./tools/dist_train.sh ./configs/eqvssm/upernet_eqvssm_4xb4-15k_loveda-512x512_small.py 4;
CUDA_VISIBLE_DEVICES=0,1,6,7 bash ./tools/dist_train.sh ./configs/eqvssm/upernet_eqvssm_4xb4-15k_potsdam-512x512_small.py 4;
CUDA_VISIBLE_DEVICES=0,1,6,7 bash ./tools/dist_train.sh ./configs/eqvssm/upernet_eqvssm_4xb4-15k_vaihingen-512x512_small.py 4;
```
